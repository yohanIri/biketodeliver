...
class Bicicleta{
    ...
    protected $accesoriosCompatible;
    /** @ORM\Column(type="string", length=20) */
    ...
    /**
     * Set accesoriosCompatible
     *
     * @param string $accesoriosCompatible
     * @return Bicicleta
     */
    public function setAccesoriosCompatible($accesoriosCompatible)
    {
        $this->accesoriosCompatible = $accesoriosCompatible;

        return $this;
    }

    /**
     * Get accesoriosCompatible
     *
     * @return string 
     */
    public function getAccesoriosCompatible()
    {
        return $this->accesoriosCompatible;
    }
